...
// var userRoule=window.prompt('enter your Roule');
// // if (userRoule == admin){
// //     .console.log('y c any thing');
// // }
// // else if(userRoule == number){
// //     console.log('y c updet');
// // }
// // else if(userRoule == number){
// //     console.log('y c updet');
// // }
...
//     return result ;
// }
// var avg = getAvg(200 , 400)


// function clacprice (co , ads , tax ,pro){
//     var basicprice = co + pro ;
//     var basicpriceAfterTax = basicprice + (co *tax) ;
//     var finalprice 
...
//     age: 30,
//     job: 'accountant',
//     wife: { fullName : "aya", age: 27 ,job: 'accountant'}
//     play : function(game){.console.log();}
...
// var productdisecraptioninput = document.getElementById("productdisecraptioninput")
...
//         productdisecraption: productdisecraptioninput.value,
//     }
//     productcontener.push(prodact)
//     console.log(productcontener);
// }
// var productnameinput = document.getElementById("productnameinput") 
// var productpriceinput = document.getElementById("productpriceinput") 
// var productdisecraptioninput = document.getElementById("productdisecraptioninput") 
// var  productacontainer =[ ];
...
//         productdisecraption:productdisecraptioninput.value,
//     }
//      productacontainer .push(product)

//     console.log(productacontainer);
//     clearFORM  ()
// }
// function clearFORM(){
//     productnameinput.value = ('');
//     productpriceinput.value = ('');
//     productdisecraptioninput.value = ('');
// }
...
var quotes = [
    ...
    {'name': '--Frank Zappa', 
     'example': '"So many books, so little time."'
    },
    {'name': '--Marcus Tullius Cicero', 
     'example': '"A room without books is like a body without a soul."'
    },
    {'name': '--Mae West', 
     'example': '"You only live once, but if you do it right, once is enough."'
    },
    {'name': '--Elbert Hubbard', 
     'example': '"A friend is someone who knows all about you and still loves you."'
    },
    {'name': '--Mahatma Gandhi', 
     'example': '"Live as if you were to die tomorrow. Learn as if you were to live forever."'
    },
]

function quote(){
    var random = Number.parseInt(Math.random()*quotes.length + 1);
    document.querySelector('#exampleOutPut').textContent =`${quotes[random].example}`;
    document.querySelector('#nameOutPut').textContent = `${quotes[random].name}`;
}
